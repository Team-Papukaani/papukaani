...
class TestDeviceFrontend(StaticLiveServerTestCase):
    ...
    def test_if_unremoved_birds_attach_button_is_not_visible(self):
        ...
        self.perform_removal_and_assert_with_optional_attach("03-11-2015 00:00", self.page.ATTACHER.is_displayed(),
                                                             True)
    ...
    def test_attacher_is_hidden_after_attach(self):
        self.perform_removal_and_assert_with_optional_attach("03-11-2015 00:00", self.page.ATTACHER.is_displayed(),
                                                             False, "12345TESTINDIVIDUAL", "12-11-2015 00:00")
    ...
    def test_cant_remove_if_remove_time_is_before_attach_time(self):
        self.perform_removal_and_assert_with_optional_attach("01-10-2015 02:00", self.page.ATTACHER.is_displayed(),
                                                             False)

    def test_cant_remove_if_remove_time_is_in_the_future(self):
        self.perform_removal_and_assert_with_optional_attach("13-12-2114 00:00", self.page.ATTACHER.is_displayed(),
                                                             False)

    def test_can_remove_when_all_conditions_are_met(self):
        self.perform_removal_and_assert_with_optional_attach("03-11-2015 14:00", True)

    def test_cant_attach_if_start_time_is_in_future(self):
        self.perform_removal_and_assert_with_optional_attach("03-11-2015 14:00", self.page.ATTACHER.is_displayed(),
                                                             True, "12345TESTINDIVIDUAL", "13-12-2114 00:00")

    def test_cant_attach_if_start_time_overlaps_with_another_device(self):
        self.perform_removal_and_assert_with_optional_attach("03-11-2015 14:00", self.page.ATTACHER.is_displayed(),
                                                             True, "12345TESTINDIVIDUAL", "02-11-2015 16:00")

    def test_can_attach_id_all_conditions_are_met(self):
        self.perform_removal_and_assert_with_optional_attach("03-11-2015 14:00", self.page.ATTACHER.is_displayed(),
                                                             "12345TESTINDIVIDUAL", "04-11-2015 16:00")

    def test_errors_messages_are_shown_when_validation_fails(self):
        self.perform_removal_and_assert_with_optional_attach("03-11-2015 14:00", (
            len(self.page.driver.find_element_by_id("errors").text) > 0), True, "12345TESTINDIVIDUAL",
                                                             "13-12-2114 00:00")
    ...
    def perform_removal_and_assert_with_optional_attach(self, time, result, expected, attachname=None, attachtime=None):
        self.page.REMOVE_TIME.send_keys(time)
        self.page.REMOVE.click()

        if attachname and attachtime:
            self.page.attach_individual(attachname, attachtime)

        self.assertEquals(self.page.ATTACHER.is_displayed(), expected)
